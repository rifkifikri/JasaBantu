                       ...
                       <div class="row">
                          <div class="col-sm-12">
                             <div class="banner_taital_main">
                                <h1 class="banner_taital">JASA BANTU DALAM KEBUTUHAN TUGAS ANDA</h1>
                                <p class="banner_text">Kami Hadir dalam membantu anda dalam kesulitan mengerjakan tugas maupun dalam memperbaiki laptop maupun komputer kesayangan anda </p>
                                <div class="btn_main">
                                   <div class="started_text active"><a href="https://api.whatsapp.com/send?phone=628991866979">Contact US</a></div>
                 ...
                 <div class="carousel-item">
                    <div class="container">
                       <div class="row">
                          <div class="col-sm-12">
                             <div class="banner_taital_main">
                                <h1 class="banner_taital">JASA BANTU SERVICE PERANGKAT</h1>
                                <p class="banner_text">Kami Hadir dalam membantu anda dalam kesulitan mengerjakan tugas maupun dalam memperbaiki laptop maupun komputer kesayangan anda</p>
                                <div class="btn_main">
                                   <div class="started_text active"><a href="https://api.whatsapp.com/send?phone=628991866979">Contact US</a></div>
        ...
        <div class="container-fluid">
           <div class="row">
              <div class="col-sm-12">
                 ...
                 <p class="services_text_1">Kami hadir membantu anda dalam kemudahan mengerjakan tugas dan servis perangkat anda</p>
              </div>
           </div>
              ...
              <div class="row">
                 <div class="col-lg-3 col-sm-6">
                    <div class="box_main ">
                       ...
                       <h4 class="development_text">Tugas Kuliah</h4>
                       <p class="services_text">Menerima pengerjaan tugas kuliah seperti pembuatan PPT, makalah/Proposal, serta tugas lainnya</p>
                 ...
                 <div class="col-lg-3 col-sm-6">
                    <div class="box_main">
                       ...
                       <h4 class="development_text">Jasa Editing</h4>
                       <p class="services_text">Kami menerima pengerjaan pembuatan Logo maupun edit vidio sebagai tugas kuliah maupun kebutuhan usaha anda</p>
                       <!-- <div class="readmore_bt"><a href="#">Read More</a></div> -->
                    </div>
                 </div>
                 <div class="col-lg-3 col-sm-6">
                 ...
                 <div class="col-lg-3 col-sm-6">
                    <div class="box_main">
                       ...
                       <h4 class="development_text">Service Perangkat Keras</h4>
                       <p class="services_text">Kami juga hadir bagi anda yang ingin melakukan service perangkat keras anda seperti upgrade ram, intall ulang OS, maupun penggantian sparepart laptop, hp, maupun pc kesayangan anda.</p>
                       <!-- <div class="readmore_bt"><a href="#">Read More</a></div> -->
                    </div>
                 </div>
              </div>
                 ...
                 <div class="nav-tabs-navigation">
                    <!-- <div class="nav-tabs-wrapper">
                       <ul class="nav " data-tabs="tabs">
                          <li class="nav-item">
                             <a class="nav-link" href="#" data-toggle="tab">Category  filter</a>
                          </li>
                          <li class="nav-item">
                             ...
                             <div class="row">
                                <div class="col-md-4">
                                   ...
                                   <div class="project_main">
                                      <h2 class="work_text">Sistem Pengajuan Ruangan</h2>
                                      <p class="dummy_text">Sistem ini digunakan untuk melakukan proses pemesanan ruangan rapat dan dormitory pada sebuah instansi di Karawang Jawa Barat</p>
                                   </div>
                                </div>
                                <div class="col-md-4">
                                   <div class="container_main">
                    ...
                    <div class="row">
                       <div class="col-md-12">
                         ...
                         <div class="testimonial_section_2">
                             ...
                             <p class="textimonial_text">Alhamdulillah sudah okey, tinggal demo program di dosen pembimbing dan ujian ta-nya mohon Do'a restunya semoga aman, lancar mencapai hasil maksimal Aamiin</p>
                         </div>
                         <div class="testimonial_section_2">
                             <h2 class="client_name_text"><img src="images/quick-icon.png"> <span style="float: right;">Anonym</span></h2>
                             <p class="textimonial_text">Pengerjaannya sangat cepat dan sesuai dengan permintaan</p>
                         </div>
                       </div>
                    </div>
                 </div>
